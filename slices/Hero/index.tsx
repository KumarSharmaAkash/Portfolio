...
import {Shapes} from "../Hero/Shapes.jsx";
/**
 * Props for `Hero`.
 */
...
const Hero = ({ slice }: HeroProps): JSX.Element => {
  ...
  return (
    ...
    ><div className="grid min-h[70vh] grid-cols-1 md:grid-cols-2 items-center">
      ...
      <span className=" job-title block bg-gradient-to-tr from-blue-800 via-red-200 to-yellow-400 bg-clip-text text-2xl font-bold uppercase tracking-[.2em] text-transparent opacity-100 md:text-4xl">{slice.primary.tag_line}</span>
      </div>
      </div>
    </Bounded>
  );
